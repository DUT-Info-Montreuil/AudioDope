    ...
    class VueConnexion extends VueGenerique {
        ...
        public function form_inscription() {
            ...
            if (isset($_GET['erreur'])) {
                echo '<div class="alert alert-warning alert-dismissible fade show" role="alert" id="alert"> <p>';
                switch($_GET['erreur']) {
            ...
            echo '<FORM ACTION="index.php?module=connexion&action=inscription" METHOD="POST" id="form_insc"> 
        ...
        public function form_connexion() {
            ...
            if (isset($_GET['erreur'])) {
                echo '<div class="alert alert-warning alert-dismissible fade show" role="alert" id="alert"> <p>Nom d\'utilisateur ou mot de passe incorrecte</p></div>';
            }
            echo
        ...
        public function parametres($email) {
            ...
            echo "</div>";
            echo '<div id="div_form_email">';
            echo '<FORM ACTION="" METHOD="POST" id="form_email"> 
            <input type="hidden" name="token" value='.$_SESSION['token'].'>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text">
