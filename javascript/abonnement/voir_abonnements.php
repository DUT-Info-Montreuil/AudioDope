<?php
    ...
    if (isset($_SESSION['idUser'])) {
        ...
        $listeAbonnement = $bdd->prepare('select idUser, login, pfp from Abonner inner join Utilisateurs on (Abonner.idUserAbonnement= Utilisateurs.idUser) where idUserAbonne = ?');
